...
# Thanks to "Ex Vito" for this code.
...
class fileUpload:
    ...
    def fileUploadedEvent( self, temp_filename, orig_filename ):
        logging.info("temp_filename=%s, orig_filename=%s"  % ( temp_filename, orig_filename ))

    def __init__(self, handler=None):
        self.handler = handler
        if not self.handler:
            self.handler = self.fileUploadedEvent
    ...
    def upload(self, theFile=None):
        ...
        temp_filename = theFile.file.name
        real_filename = theFile.filename
        theFile.file.close()
        self.handler( temp_filename, real_filename )
